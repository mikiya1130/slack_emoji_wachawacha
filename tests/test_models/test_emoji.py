...
class TestEmojiDataValidation:
    ...
    def test_emoji_code_validation_required(self):
        ...
        with pytest.raises(ValueError, match="code is required"):
            EmojiData(code="", description="Test description")

        # Noneのコードでエラーが発生することを確認
        with pytest.raises(ValueError, match="code is required"):
            EmojiData(code=None, description="Test description")
    ...
    def test_description_validation_required(self):
        ...
        with pytest.raises(ValueError, match="description is required"):
            EmojiData(code=":smile:", description="")

        # Noneの説明文でエラーが発生することを確認
        with pytest.raises(ValueError, match="description is required"):
            EmojiData(code=":smile:", description=None)
    ...
    def test_emotion_tone_validation(self):
        ...
        for tone in valid_tones:
            emoji = EmojiData(code=":test:", description="Test", emotion_tone=tone)
        ...
        for invalid_tone in invalid_tones:
            with pytest.raises(ValueError, match="Invalid emotion_tone"):
                EmojiData(code=":test:", description="Test", emotion_tone=invalid_tone)
    ...
    def test_priority_validation(self):
        ...
        for priority in valid_priorities:
            emoji = EmojiData(code=":test:", description="Test", priority=priority)
        ...
        for invalid_priority in invalid_priorities:
            with pytest.raises(ValueError, match="Invalid priority"):
                EmojiData(code=":test:", description="Test", priority=invalid_priority)
    ...
    def test_embedding_validation(self):
        ...
        emoji = EmojiData(code=":test:", description="Test", embedding=valid_embedding)
        ...
        for wrong_embedding in wrong_dimension_embeddings:
            with pytest.raises(ValueError, match="Invalid embedding dimension"):
                EmojiData(code=":test:", description="Test", embedding=wrong_embedding)
...
class TestEmojiDataMethods:
    ...
    def test_is_valid_method(self):
        ...
        # 有効なデータ
        valid_emoji = EmojiData(code=":smile:", description="Happy expression")
    ...
    def test_str_and_repr_methods(self):
        ...
        emoji = EmojiData(code=":smile:", description="Happy expression")
...
class TestEmojiDataComparison:
    ...
    def test_equality_comparison(self):
        ...
        emoji1 = EmojiData(code=":smile:", description="Happy expression")

        emoji2 = EmojiData(code=":smile:", description="Happy expression")

        emoji3 = EmojiData(code=":frown:", description="Sad expression")
    ...
    def test_hash_support(self):
        ...
        emoji2 = EmojiData(code=":frown:", description="Sad expression")

        # 辞書のキーとして使用できることを確認
        emoji_dict = {emoji1: "happy", emoji2: "sad"}
...
class TestEmojiDataEdgeCases:
    ...
    def test_unicode_emoji_code_handling(self):
        ...
        for code in unicode_codes:
            emoji = EmojiData(code=code, description="Unicode test")
            assert emoji.code == code
    ...
    def test_very_long_description_handling(self):
        ...
        emoji = EmojiData(code=":test:", description=long_description)
