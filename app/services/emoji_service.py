...
class EmojiService:
    ...
    def __init__(self, database_service, cache_enabled: bool = True, cache_ttl: int = 3600):
        """
        EmojiServiceの初期化
        ...
        logger.info(f"EmojiService initialized with cache_enabled={cache_enabled}, cache_ttl={cache_ttl}")
    ...
    async def find_similar_emojis_by_text(self, text: str, limit: int = 3) -> List[EmojiData]:
